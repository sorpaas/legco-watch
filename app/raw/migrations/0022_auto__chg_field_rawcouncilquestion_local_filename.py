...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RawCouncilQuestion.local_filename'
        db.alter_column(u'raw_rawcouncilquestion', 'local_filename', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'RawCouncilQuestion.local_filename'
        db.alter_column(u'raw_rawcouncilquestion', 'local_filename', self.gf('django.db.models.fields.CharField')(max_length=255))
