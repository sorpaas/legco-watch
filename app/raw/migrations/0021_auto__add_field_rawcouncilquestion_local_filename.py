...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RawCouncilQuestion.local_filename'
        db.add_column(u'raw_rawcouncilquestion', 'local_filename',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RawCouncilQuestion.local_filename'
        db.delete_column(u'raw_rawcouncilquestion', 'local_filename')
    ...
    models = {
        ...
        'raw.rawcouncilquestion': {
            ...
            'last_crawled': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'last_parsed': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'local_filename': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '255', 'blank': 'True'}),
