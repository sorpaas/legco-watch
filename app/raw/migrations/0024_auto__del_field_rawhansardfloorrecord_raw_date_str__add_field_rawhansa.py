...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'RawHansardFloorRecord.raw_date_str'
        db.delete_column(u'raw_rawhansardfloorrecord', 'raw_date_str')

        # Adding field 'RawHansardFloorRecord.url'
        db.add_column(u'raw_rawhansardfloorrecord', 'url',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


        # Changing field 'RawHansardFloorRecord.raw_date'
        db.alter_column(u'raw_rawhansardfloorrecord', 'raw_date', self.gf('django.db.models.fields.CharField')(max_length=100))
        # Deleting field 'RawHansardFormalRecord.raw_date_str'
        db.delete_column(u'raw_rawhansardformalrecord', 'raw_date_str')

        # Adding field 'RawHansardFormalRecord.url'
        db.add_column(u'raw_rawhansardformalrecord', 'url',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


        # Changing field 'RawHansardFormalRecord.raw_date'
        db.alter_column(u'raw_rawhansardformalrecord', 'raw_date', self.gf('django.db.models.fields.CharField')(max_length=100))
        # Deleting field 'RawHansardAgenda.raw_date_str'
        db.delete_column(u'raw_rawhansardagenda', 'raw_date_str')

        # Adding field 'RawHansardAgenda.url'
        db.add_column(u'raw_rawhansardagenda', 'url',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


        # Changing field 'RawHansardAgenda.raw_date'
        db.alter_column(u'raw_rawhansardagenda', 'raw_date', self.gf('django.db.models.fields.CharField')(max_length=100))
        # Deleting field 'RawHansardMinutes.raw_date_str'
        db.delete_column(u'raw_rawhansardminutes', 'raw_date_str')

        # Adding field 'RawHansardMinutes.url'
        db.add_column(u'raw_rawhansardminutes', 'url',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


        # Changing field 'RawHansardMinutes.raw_date'
        db.alter_column(u'raw_rawhansardminutes', 'raw_date', self.gf('django.db.models.fields.CharField')(max_length=100))

    def backwards(self, orm):
        # Adding field 'RawHansardFloorRecord.raw_date_str'
        db.add_column(u'raw_rawhansardfloorrecord', 'raw_date_str',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Deleting field 'RawHansardFloorRecord.url'
        db.delete_column(u'raw_rawhansardfloorrecord', 'url')


        # Changing field 'RawHansardFloorRecord.raw_date'
        db.alter_column(u'raw_rawhansardfloorrecord', 'raw_date', self.gf('django.db.models.fields.CharField')(max_length=50))
        # Adding field 'RawHansardFormalRecord.raw_date_str'
        db.add_column(u'raw_rawhansardformalrecord', 'raw_date_str',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Deleting field 'RawHansardFormalRecord.url'
        db.delete_column(u'raw_rawhansardformalrecord', 'url')


        # Changing field 'RawHansardFormalRecord.raw_date'
        db.alter_column(u'raw_rawhansardformalrecord', 'raw_date', self.gf('django.db.models.fields.CharField')(max_length=50))
        # Adding field 'RawHansardAgenda.raw_date_str'
        db.add_column(u'raw_rawhansardagenda', 'raw_date_str',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Deleting field 'RawHansardAgenda.url'
        db.delete_column(u'raw_rawhansardagenda', 'url')


        # Changing field 'RawHansardAgenda.raw_date'
        db.alter_column(u'raw_rawhansardagenda', 'raw_date', self.gf('django.db.models.fields.CharField')(max_length=50))
        # Adding field 'RawHansardMinutes.raw_date_str'
        db.add_column(u'raw_rawhansardminutes', 'raw_date_str',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Deleting field 'RawHansardMinutes.url'
        db.delete_column(u'raw_rawhansardminutes', 'url')


        # Changing field 'RawHansardMinutes.raw_date'
        db.alter_column(u'raw_rawhansardminutes', 'raw_date', self.gf('django.db.models.fields.CharField')(max_length=50))
