...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ParsedQuestion.replier'
        db.delete_column(u'raw_parsedquestion', 'replier')

        # Deleting field 'ParsedQuestion.subject_c'
        db.delete_column(u'raw_parsedquestion', 'subject_c')

        # Deleting field 'ParsedQuestion.subject_e'
        db.delete_column(u'raw_parsedquestion', 'subject_e')

        # Adding field 'ParsedQuestion.repliers_e'
        db.add_column(u'raw_parsedquestion', 'repliers_e',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

        # Adding field 'ParsedQuestion.repliers_c'
        db.add_column(u'raw_parsedquestion', 'repliers_c',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

        # Adding field 'ParsedQuestion.ask_subject_e'
        db.add_column(u'raw_parsedquestion', 'ask_subject_e',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

        # Adding field 'ParsedQuestion.ask_subject_c'
        db.add_column(u'raw_parsedquestion', 'ask_subject_c',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

        # Adding field 'ParsedQuestion.reply_subject_e'
        db.add_column(u'raw_parsedquestion', 'reply_subject_e',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

        # Adding field 'ParsedQuestion.reply_subject_c'
        db.add_column(u'raw_parsedquestion', 'reply_subject_c',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ParsedQuestion.replier'
        db.add_column(u'raw_parsedquestion', 'replier',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

        # Adding field 'ParsedQuestion.subject_c'
        db.add_column(u'raw_parsedquestion', 'subject_c',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

        # Adding field 'ParsedQuestion.subject_e'
        db.add_column(u'raw_parsedquestion', 'subject_e',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

        # Deleting field 'ParsedQuestion.repliers_e'
        db.delete_column(u'raw_parsedquestion', 'repliers_e')

        # Deleting field 'ParsedQuestion.repliers_c'
        db.delete_column(u'raw_parsedquestion', 'repliers_c')

        # Deleting field 'ParsedQuestion.ask_subject_e'
        db.delete_column(u'raw_parsedquestion', 'ask_subject_e')

        # Deleting field 'ParsedQuestion.ask_subject_c'
        db.delete_column(u'raw_parsedquestion', 'ask_subject_c')

        # Deleting field 'ParsedQuestion.reply_subject_e'
        db.delete_column(u'raw_parsedquestion', 'reply_subject_e')

        # Deleting field 'ParsedQuestion.reply_subject_c'
        db.delete_column(u'raw_parsedquestion', 'reply_subject_c')
    ...
    models = {
        ...
        'raw.parsedquestion': {
            ...
            'ask_subject_c': ('django.db.models.fields.TextField', [], {'default': "''"}),
            'ask_subject_e': ('django.db.models.fields.TextField', [], {'default': "''"}),
            ...
            'repliers_c': ('django.db.models.fields.TextField', [], {'default': "''"}),
            'repliers_e': ('django.db.models.fields.TextField', [], {'default': "''"}),
            'reply_c': ('django.db.models.fields.TextField', [], {'default': "''"}),
            'reply_e': ('django.db.models.fields.TextField', [], {'default': "''"}),
            'reply_subject_c': ('django.db.models.fields.TextField', [], {'default': "''"}),
            'reply_subject_e': ('django.db.models.fields.TextField', [], {'default': "''"}),
            'uid': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
