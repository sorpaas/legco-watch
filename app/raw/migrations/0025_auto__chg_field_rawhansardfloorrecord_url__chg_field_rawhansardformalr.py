...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RawHansardFloorRecord.url'
        db.alter_column(u'raw_rawhansardfloorrecord', 'url', self.gf('django.db.models.fields.URLField')(max_length=200))

        # Changing field 'RawHansardFormalRecord.url'
        db.alter_column(u'raw_rawhansardformalrecord', 'url', self.gf('django.db.models.fields.URLField')(max_length=200))

        # Changing field 'RawHansardAgenda.url'
        db.alter_column(u'raw_rawhansardagenda', 'url', self.gf('django.db.models.fields.URLField')(max_length=200))

        # Changing field 'RawHansardMinutes.url'
        db.alter_column(u'raw_rawhansardminutes', 'url', self.gf('django.db.models.fields.URLField')(max_length=200))

    def backwards(self, orm):

        # Changing field 'RawHansardFloorRecord.url'
        db.alter_column(u'raw_rawhansardfloorrecord', 'url', self.gf('django.db.models.fields.TextField')())

        # Changing field 'RawHansardFormalRecord.url'
        db.alter_column(u'raw_rawhansardformalrecord', 'url', self.gf('django.db.models.fields.TextField')())

        # Changing field 'RawHansardAgenda.url'
        db.alter_column(u'raw_rawhansardagenda', 'url', self.gf('django.db.models.fields.TextField')())

        # Changing field 'RawHansardMinutes.url'
        db.alter_column(u'raw_rawhansardminutes', 'url', self.gf('django.db.models.fields.TextField')())
